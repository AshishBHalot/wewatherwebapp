			...
			<div id="header"></div>
               ...
               <br>
                <div class="signed-in-bg">
				    ...
				    <h2 class="reg-head">Post Successfully Uploaded!</h2>
				    <p>Thank you for posting on our weather news portal !</p>
				    <a href="<%= request.getAttribute("post")%> ">
                        <button type="submit" class="btn log-btn form-submit">Go to Post</button>
                    </a>
				</div>
                </div>
        </div>
