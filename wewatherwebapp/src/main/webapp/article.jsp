...
<body>
	...
	function imageClicked() {
        ...
        var textContent = "in my village weather is not stable currently in the month of september their is no rain from 7-8 days and we can't keep up our crops of soyabean without the rain water as without irrigation their is no production and our farmers are dying . so to reduce the stress of farmer I will provide with correct info about rainfall which keep them a hope.";
        ...
        try {
            fetch("https://eastus.tts.speech.microsoft.com/cognitiveservices/v1", {
              method: "POST",
              headers: {
                "Ocp-Apim-Subscription-Key": "ae9384d0613a435980692577f4748728",
