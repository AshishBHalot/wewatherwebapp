...
<script>
	...
	boxesData.forEach(function(boxData) {
	  ...
	  var weatherUrl = 'https://api.openweathermap.org/data/2.5/weather?q=' + boxData.city + '&appid=36d2bb03bc2d84b4f43178f2e0b63fe8';
	  ...
	  fetch(weatherUrl)
	    ...
	    .then(function(data) {
	      ...
	      // Make a request to the Pexels API for location image
              var apiKey="3RRyt4LPvhZrPMDmHZMDemUvXJJEcidMxdLPhf3awKKEBhpLJK7sHaVT"
